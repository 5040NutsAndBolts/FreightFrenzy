...
public class AutoPaths
{
    ...
    public ArrayList<AutoFunction> allPaths;
    public boolean red;
    ...
    public AutoFunction spinDuck = new AutoFunction()
    {
        @Override
        void step()
        {
    ...
    public AutoFunction intake = new AutoFunction()
    {
    ...
    public AutoFunction deposit = new AutoFunction()
    {
        @Override
        void step()
        {
    ...
    public AutoFunction returnFromDeposit=new AutoFunction(){
        @Override
        void step()
        {
    ...
    public AutoFunction park = new AutoFunction()
    {
        @Override
        void step()
        {
    ...
    public AutoFunction parkWarehouse =new AutoFunction()
    {
        @Override
        void step()
        {
    ...
    public AutoPaths(LinearOpMode opMode,Hardware hardware, boolean isRed)
    {
        ...
        robot=hardware;
        red=isRed;
        allPaths=new ArrayList<AutoFunction>();
        spinDuck.name="spinDuck";
        allPaths.add(spinDuck);
        parkWarehouse.name="parkW";
        allPaths.add(parkWarehouse);
        park.name="park";
        allPaths.add(park);
        intake.name="intake";
        allPaths.add(intake);
        deposit.name="deposit";
        allPaths.add(deposit);
        returnFromDeposit.name="returnFromDepo";
        allPaths.add(returnFromDeposit);
